...
window.NovaHairAIFlows = {
  ...
  nodes: {
    ...
    close_ready: {
      ...
      redirect: '/pages/novahair-sales-staging#buy'
    },
    ...
    exit_to_buy:     { id: 'exit_to_buy',     type: 'end', redirect: '/pages/novahair-sales-staging#buy', messages: ['מעבירה אותך לבחירת הגוון והחבילה.'] },
