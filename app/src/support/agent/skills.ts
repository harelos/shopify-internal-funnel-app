...
export const supportSkills: SupportSkill[] = [
  ...
  },
  {
    ...
    patterns: [/\bcancel\b.*\border\b/i, /לבטל.*הזמנה/i, /ביטול.*הזמנה/i],
    baseConfidence: 0.93,
  ...
  },
  {
    ...
    patterns: [/\bchange\b.*\border\b/i, /\bremove\b.*\bitem\b/i, /\bchange\b.*\bitem\b/i, /לשנות.*הזמנה/i, /להחליף.*בהזמנה/i],
    baseConfidence: 0.84,
  ...
  },
  {
    ...
    patterns: [/\bexchange\b.*\bitem\b/i, /\bexchange\b.*\border\b/i, /\bswap\b.*\bitem\b/i, /להחליף.*מוצר/i, /החלפה.*מוצר/i],
    baseConfidence: 0.9,
  ...
  },
  {
    ...
    patterns: [/\breturn\b.*\border\b/i, /\breturn\b.*\bitem\b/i, /להחזיר/i, /החזרה/i],
    baseConfidence: 0.88,
  ...
  },
  {
    ...
    patterns: [/\brefund\b/i, /money back/i, /החזר כספי/i, /זיכוי/i],
    baseConfidence: 0.9,
