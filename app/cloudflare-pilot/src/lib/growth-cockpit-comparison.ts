...
export const GROWTH_COCKPIT_METRIC_DEFINITIONS: GrowthCockpitMetricDefinition[] = [
  ...
  },
  {
    key: "cm1",
    label: "CM1",
    definition: "Contribution margin before advertising spend.",
    source: "Growth Cockpit financial contract",
    calculation: "Revenue - CJ variable costs - payment fees",
  },
  {
    key: "cm2",
    label: "CM2",
    definition: "Contribution margin after advertising spend.",
    source: "Growth Cockpit financial contract",
    calculation: "CM1 - Meta spend",
  },
  {
    key: "cm2Margin",
    label: "CM2 margin",
    definition: "Contribution margin after advertising as a percentage of revenue.",
    source: "Growth Cockpit financial contract",
