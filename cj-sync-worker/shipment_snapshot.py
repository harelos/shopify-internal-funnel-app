...
def _track_snapshot(token: str, tracking_number: str) -> dict[str, Any]:
    ...
    return {
        ...
        "cjMailNo": row.get("cjMailNo") or None,
    }
        ...
        try:
            ...
            raw = {
                **base,
                ...
                # The full number lets the Worker fetch the live CJ events for
                # the support AI and the storefront tracking page.
                "trackingNumber": tracking_number or None,
